	...
	while (i < numItems) do
		...
		if (itemID < NUM_WEAPONS) then --Validity check
			if (WEAPON_DATA[itemID + LUA_TABLES_SUCK][WEAPON_TYPE] == WEAPONTYPE_OTHER and WEAPON_DATA[itemID + LUA_TABLES_SUCK][WEAPON_SKILL] > 0) then
				...
				if (WEAPON_DATA[itemID + LUA_TABLES_SUCK][WEAPON_TYPE] == WEAPONTYPE_OTHER and WEAPON_DATA[itemID + LUA_TABLES_SUCK][WEAPON_SKILL2] > 0) then --Second skill?
					skills[WEAPON_DATA[itemID + LUA_TABLES_SUCK][WEAPON_SKILL2]] = 1;
				end
			end
		end
		i = i + 1;
